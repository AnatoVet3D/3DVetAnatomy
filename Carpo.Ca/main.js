const model = '8715abdd17da48a297b99ec2c7a51af7'; // Modelo de referencia a Sketchfab,este fichero cuando lo abres irá al modelo de ese código
  ...
  success = function (api) {
    ...
    api.addEventListener('viewerready', function () {
      ...
      api.getNodeMap(function (err, nodes) {
        ...
        for (let i = 0; i < 37; i++) { // R: Según el nº de anotaciones modificar el último número
